...
cbar = fig.colorbar(m, cax=ax_cb, label='下向き放射フラックス (W/m²)', orientation='vertical')
...
fig.text(0.92, 0.0, '太陽天頂角: 30°', ha='center', va='top', fontsize=10)

# fig.tight_layout()
# fig.subplots_adjust(bottom=0.18)
fig.savefig(f'out/{out_dir}/02_flux_xz_comparison.png', dpi=300, bbox_inches='tight')
