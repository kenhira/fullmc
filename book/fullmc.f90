program test_fullmc
    ...
    call photon_initloc(source, ix, iy, iz, ia, xarr, yarr, zarr, dx, dy, dz, nx, ny, nz, maxx, maxy, maxz, &
        rloc, rindsrc, rind)
    !-- direction
    call photon_initdir(source, dirsol, dirview, rdir, rdir_sign)
    !-- weight
    weight = init_weight
    ...
    do while (it < itmax)
        ...
        call photon_intersect(rind, rloc, rdir, rdir_sign, xarr, yarr, zarr, rdist, rdloc, icase, isign)
...
contains
    ...
    subroutine photon_intersect(r5ind, r5loc, r5dir, r5dir_sign, xarr, yarr, zarr, rdist, rdloc, icase, isign)
        implicit none
    ...
    subroutine photon_raytrace(rloc, rind, dirsol, itlpbmax, kext, xarr, yarr, zarr, nx, ny, nz, dxs, transfer_mode, &
        ...
        do while (itlpb < itlpbmax)
            ...
            call photon_intersect(rlpbind, rlpbloc, rlpbdir, rlpbdir_sign, xarr, yarr, zarr, rdist, rdloc, icase, isign)
